...
class ComponentsController extends AppController
{
    ...
    public function add()
    {
        ...
        $dishes = $this->Components->Dishes->find('list', ['limit' => 200]);
        $ingredients = $this->Components->Ingredients->find('list', ['limit' => 200]);
        $this->set(compact('component', 'dishes', 'ingredients'));
        $this->set('_serialize', ['component']);
    }
